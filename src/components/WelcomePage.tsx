...
function WelcomePage() {
    return (
        <>
            ...
            <div className="flex flex-row text-center items-center justify-center w-2/5 pt-35 pb-56 pl-25 pr-25 bg-linear-to-r from-base to-primary-600">
                <div className="flex flex-col text-center items-center shadow-2xl w-full h-full bg-base rounded-2xl pt-10">
                    ...
                    <form>
                        <div className="flex flex-col space-y-4 w-75 mt-15">
                            ...
                            <button
                                type="submit"
                                className="bg-base hover:bg-gray-200 text-primary-400 mb-6 rounded-md py-2 text-lg hover:bg-primary-500 transition duration-200"
                            >
                                Sign Up
                            </button>
                        </div>
                    </form>
                    <a href="/forgot-password" className="text-gray-400 hover:text-gray-600 text-sm mt-5">Forgot Your Password?</a>
                </div>
            </div>
        </>
    );
